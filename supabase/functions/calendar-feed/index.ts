...
function buildMatchers(aliases: Record<string, string[]>): AgentMatcher[] {
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const agentMatchers: AgentMatcher[] = aliasMap ? buildMatchers(aliasMap) : []
